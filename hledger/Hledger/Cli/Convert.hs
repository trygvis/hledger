...
import Safe (atDef, maximumDef, readDef, readMay)
...
rulesFileFor opts csvfile = 
    fromMaybe (replaceExtension csvfile ".rules") (rulesFileFromOpts opts)
...
tests_Hledger_Cli_Convert = TestList [
  ...
  ,"convert rules parsing: accountrule" ~:
